(function ($) {
    ...
    $(".mode").on("click", function () {
        ...
        var type = $('.mode i').attr('class');
        if (type == 'fa fa-lightbulb-o') {
            console.log("In Dark Mode");
            localStorage.setItem("theme_pref", "dark");
            $.get( "/api/dark-mode/", function( data ) {
                console.log(data);
            });
        }
        if (type == 'fa fa-moon-o') {
            console.log("In Light Mode");
            localStorage.setItem("theme_pref", "light");
            $.get( "/api/light-mode/", function( data ) {
                console.log(data);
            });
        }
    ...
    // for the sake of accounts pages 
    // var page = window.location.pathname; 
    // if (!(page.includes('register') || page.includes('login'))) {
    //     var theme_pref = localStorage.getItem("theme_pref") || 'light';
    //     if (theme_pref == 'dark') {
    //         $('.mode i').toggleClass("fa-moon-o").toggleClass("fa-lightbulb-o");
