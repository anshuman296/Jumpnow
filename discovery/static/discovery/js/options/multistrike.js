...
function start_chart_render_process() {
    ...
    var get_data = { "ticker": $('#autocomplete').val(), "expiry_date": $('#expiry').val(), "strikes": prices, "intraday_ind": intraday_ind };
    $.ajax({
        ...
        success: function(data){
            $("#chart_ld").fadeOut();
            $("#warning").fadeOut();
            render_chart_from_api(data, "multistrike_chart");
        },
        error: function (err) {
        $("#chart_ld").fadeOut();
        $("#warning").fadeIn();    
        ...
        processData: false,
        type: 'POST',
        url: 'http://srirajk.herokuapp.com/multistrikeoi'
    });
}
